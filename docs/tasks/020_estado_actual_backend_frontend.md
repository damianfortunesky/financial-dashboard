...
- Ruta `/budget`.
- Vista tipo planilla mensual, inspirada en presupuesto Excel.
- Usa ingresos, gastos, compras, categorías, comercios y medios de pago.
- Muestra 13 meses, secciones, filas por agrupación y totales.
- Totales obligatorios: `TOTAL INGRESOS`, `TOTAL GASTOS`, `TOTAL COMPRAS`, `PASIVO`, `INGRESO NETO`.
...
| `frontend/src/features/budget/BudgetPage.tsx` | Vista presupuesto tipo planilla por mes |
...
- [ ] Presupuesto muestra 13 meses, agrupaciones y totales usando datos reales.
