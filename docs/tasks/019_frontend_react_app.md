...
Debe replicar una vista tipo planilla/Excel basada en el modelo real de datos.

Reglas:

- Ruta `/budget` y link de sidebar `Presupuesto`.
- Usar datos existentes: ingresos, gastos, compras, categorías, comercios y medios de pago.
- Mostrar 13 columnas mensuales desde el primer mes con datos disponible.
- Agrupar ingresos por descripción.
- Agrupar gastos por `medio de pago · categoría`.
- Agrupar compras por `medio de pago · comercio`.
- Incluir filas de sección y totales: `TOTAL INGRESOS`, `TOTAL GASTOS`, `TOTAL COMPRAS`, `PASIVO`, `INGRESO NETO`.
- Usar estética de planilla con encabezado negro, secciones celestes, gastos naranja, totales rosados e ingreso neto verde.
- La tabla debe tener scroll horizontal, primera columna sticky y montos en formato ARS.
